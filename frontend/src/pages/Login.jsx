...
import { Lock, Mail, CheckSquare, Sparkles, AlertCircle, Loader2 } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col justify-center items-center px-4 font-sans relative overflow-hidden">
      ...
      <div className="w-full max-w-md z-10">
        ...
        <div className="bg-slate-900/55 backdrop-blur-xl border border-slate-800 rounded-2xl p-8 shadow-2xl relative">
          ...
          <h2 className="text-xl font-bold mb-6 text-white text-center">Log In</h2>
          
          {error && (
            <div className="flex items-start gap-2.5 bg-rose-500/10 border border-rose-500/20 text-rose-400 p-3 rounded-lg text-sm mb-5 leading-snug animate-shake">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              ...
              className="w-full py-2.5 bg-indigo-600 hover:bg-indigo-500 text-white font-bold rounded-lg shadow-lg shadow-indigo-600/15 transition-all active:scale-98 disabled:opacity-50 disabled:pointer-events-none mt-2.5 flex items-center justify-center gap-2"
            >
              {isSubmitting ? (
                <>
